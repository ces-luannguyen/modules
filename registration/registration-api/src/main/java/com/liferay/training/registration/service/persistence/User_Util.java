...
public class User_Util {
	 ...
	 * @throws NoSuchUser_Exception if a matching user_ could not be found
	 */
	public static User_ findByUUID_G(String uuid, long groupId)
		throws com.liferay.training.registration.exception.
			NoSuchUser_Exception {
	 ...
	 */
	public static User_ fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching user_, or <code>null</code> if a matching user_ could not be found
	 */
	public static User_ fetchByUUID_G(
	 ...
	 */
	public static User_ removeByUUID_G(String uuid, long groupId)
		throws com.liferay.training.registration.exception.
			NoSuchUser_Exception {
	 ...
	 * @return the matching user_s
	 */
	public static List<User_> findByZipCode(String zipCode) {
	 ...
	 * @return the range of matching user_s
	 */
	public static List<User_> findByZipCode(
	 ...
	 * @throws NoSuchUser_Exception if a matching user_ could not be found
	 */
	public static User_ findByZipCode_First(
	 ...
	 * @return the first matching user_, or <code>null</code> if a matching user_ could not be found
	 */
	public static User_ fetchByZipCode_First(
		String zipCode, OrderByComparator<User_> orderByComparator) {
	 ...
	 * @throws NoSuchUser_Exception if a matching user_ could not be found
	 */
	public static User_ findByZipCode_Last(
			String zipCode, OrderByComparator<User_> orderByComparator)
		throws com.liferay.training.registration.exception.
			NoSuchUser_Exception {
	 ...
	 * @return the last matching user_, or <code>null</code> if a matching user_ could not be found
	 */
	public static User_ fetchByZipCode_Last(
		String zipCode, OrderByComparator<User_> orderByComparator) {
	 ...
	 * @throws NoSuchUser_Exception if a user_ with the primary key could not be found
	 */
	public static User_[] findByZipCode_PrevAndNext(
		...
		return getPersistence().findByZipCode_PrevAndNext(
			userId, zipCode, orderByComparator);
	}
