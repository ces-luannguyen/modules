<liferay-ui:search-container  deltaConfigurable="true" emptyResultsMessage="no-events-found" delta="${delta }" total="${events_reg_count}">
 <liferay-ui:search-container-results results="${events_reg }" >
